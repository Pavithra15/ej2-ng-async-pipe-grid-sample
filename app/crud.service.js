...
var httpOptions = {
    headers: new http_1.HttpHeaders({ 'Accept': 'application/json', 'Origin': 'http://test.org', 'Content-Type': 'application/json' })
};
var CrudService = (function (_super) {
    ...
    CrudService.prototype.getAllData = function () {
        return this.http.get(this.customersUrl, httpOptions)
